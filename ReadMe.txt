Folder 
-dataset
-Data all data related to EPS
-Dataset-2 all data related to Sales data
...
-Long-term_Forecasting
run sales experiment using Sale.ipynb (4d tensor)
run EPS rolling window using EPS_rolling.ipynb (3d tensor)